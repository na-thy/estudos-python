...
if cadastrados >=1:
    ...
    print(f"Total alunos aprovados: {total_alunos_aprovados:.0f}%")
    print(f"Total alunos em exame: {total_alunos_exame:.0f}%.")
    print(f"Total alunos reprovados: {total_alunos_reprovados:.0f}%")
